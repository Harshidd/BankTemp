...
export const TEMPLATE_CATEGORIES = [
  ...
  { id: 'showroom-catalog', name: 'Showroom Catalog', icon: 'layout-grid' },
];
...
export const TEMPLATES: TemplateMetadata[] = [
  ...
  {
    id: 'interior-studio-showroom',
    name: 'Interior Studio Showroom',
    category: 'showroom-catalog',
    description: 'A calm, project-led interior studio template. Blends high-fidelity project showcases with material library exploration and clear consultation flows.',
    styleTag: 'Elegant Project-Led',
    status: 'ready',
    // Catalog-grade Metadata
    valueProposition: 'Spaces that inspire living, presented with practical elegance.',
    pageCount: 6,
    useCases: [
      'Interior Design Studios',
      'Architecture Practices',
      'Material & Decor Showrooms',
      'Turnkey Contracting Firms',
      'Bespoke Furniture Makers'
    ],
    strengths: [
      '6-Page Complete Studio Flow',
      'Immersive Project Showcases',
      'Material & Collection Discovery',
      'Phased Service Explanations',
      'Showroom Visit & Inquiry Integration',
      'Calm, WordPress-Friendly Architecture'
    ],
    showcaseSummary: 'Designed for design practices and showrooms that need a polished, calm visual rhythm without the hyperactivity of standard sales templates. It seamlessly integrates project storytelling with material exploration and clear showroom visit logic.',
    catalogReview: 'An elegant departure from noisy lead-gen templates. It achieves a high-end studio feel while retaining highly reusable, grounded components suitable for quick adaptation.',
  },
  {
    id: 'data-ai-saas',
    name: 'Data & AI SaaS',
  ...
  {
    id: 'furniture-showroom-catalog',
    name: 'Furniture Showroom Catalog',
    category: 'showroom-catalog',
    description: 'A calm, catalog-first showroom environment designed for premium physical products. Optimized for visual breathing room and high-fidelity product exploration.',
    styleTag: 'Premium Catalog',
    status: 'ready',
    valueProposition: 'Translating physical elegance into digital space.',
    pageCount: 6,
    useCases: [
      'High-End Furniture Brands',
      'Artisanal Product Showcases',
      'Boutique Decor Catalogs',
      'Architectural Material Galleries',
      'Luxury Lifestyle Commerce',
      'Physical Product Portfolios'
    ],
    strengths: [
      '5-Page Catalog System',
      'Calm Visual Hierarchy',
      'WordPress-Friendly Structure',
      'Editorial Grid Layouts',
      'High-Fidelity Image Focus',
      'Minimalist Typography'
    ],
    mrkdevContext: 'MRKDEV STARTER TEMPLATE',
    showcaseSummary: 'A complete catalog-first existence. It translates physical elegance into a calm, structured digital space, ensuring products lead the narrative.',
    catalogReview: 'A masterclass in restraint. It handles high-density product imagery with absolute calm and structural clarity.',
  },
  {
    id: 'interior-studio-showroom',
    name: 'Interior Studio Showroom',
    category: 'showroom-catalog',
    description: 'An architectural showcase for interior design portfolios.',
    styleTag: 'Architectural Minimal',
    status: 'ready',
  },
  {
    id: 'minimal-art-gallery',
    name: 'Minimal Art Gallery',
    category: 'showroom-catalog',
    description: 'A highly reductive gallery system prioritizing white space and focus.',
    styleTag: 'Extreme Minimal',
    status: 'draft',
  },
  {
    id: 'esther-style-gallery',
    name: 'Atmospheric Art Gallery',
    category: 'showroom-catalog',
    description: 'An atmospheric, immersive gallery layout with full-bleed cinematic imagery.',
    styleTag: 'Atmospheric Gallery',
    status: 'ready',
  },
  {
    id: 'global-contemporary-gallery',
    name: 'Global Contemporary Gallery',
    category: 'showroom-catalog',
    description: 'A visually stronger, more globally scaled contemporary gallery layout inspired by Perrotin.',
    styleTag: 'Global Dynamic',
    status: 'ready',
  },
  {
    id: 'program-led-gallery',
    name: 'Program-Led Gallery',
    category: 'showroom-catalog',
    description: 'A mature, institutional gallery system prioritizing artist directories and publishing programs.',
    styleTag: 'Institutional & Programmatic',
    status: 'ready',
  },
  {
    id: 'seo-electrician-service',
    name: 'SEO Electrician Service',
    category: 'local-business',
    description: 'A fast, trustworthy, and conversion-practical local electrician website with an emergency response focus.',
    styleTag: 'Local WordPress-style',
    status: 'ready',
  },
  {
    id: 'seo-plumber-service',
    name: 'SEO Plumber Service',
    category: 'local-business',
    description: 'A fast, reliable, and trustworthy local plumbing service template focused on urgent repairs and local SEO.',
    styleTag: 'Local WordPress-style',
    status: 'ready',
  },
  {
    id: 'seo-hvac-service',
    name: 'SEO HVAC Service',
    category: 'local-business',
    description: 'A grounded, trustworthy HVAC template emphasizing practical maintenance plans, honest diagnostics, and climate control expertise.',
    styleTag: 'Local WordPress-style',
    status: 'ready',
  },
];
